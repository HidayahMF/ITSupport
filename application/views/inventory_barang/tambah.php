<!-- HEADER -->
<div class="mb-8">
    <h2 class="text-3xl font-bold text-gray-800">Tambah Inventory Barang</h2>
    <p class="text-gray-500">Isi data berikut untuk menambahkan barang baru ke inventory</p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="status" id="status" required onchange="toggleTanggalDiserahkan()"
                    ...
                    <option value="Sudah Diterima IT">Sudah Diterima IT</option>
                    <option value="Sudah Diserahkan ke User">Sudah Diserahkan ke User</option>
                </select>
            </div>

            <!-- Tanggal Diserahkan -->
            <div id="wrapTglDiserahkan" class="hidden">
...
$(document).ready(function() {
    ...
    $('#formTambah').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('inventorybarang/simpan') ?>',
            type: 'POST',
